package com.wishto.roomdbmvvm.fragment.update
...
import com.wishto.roomdbmvvm.databinding.FragmentUpdateBinding
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.updateFirstNameEt.setText(args.currentUser.first_name)
        binding.updateLastNameEt.setText(args.currentUser.last_name)
    ...
    private fun updateItem() {
        ...
        val age =
            Integer.parseInt(binding.updateAgeEt.text.toString()) // Parses a string returns an integer.
    ...
    private fun deleteUser() {
        ...
        builder.setPositiveButton("Yes") { _, _ ->     // Make a "Yes" option and set action if the user selects "Yes"
            ...
            Toast.makeText(                                // Notification if a user is deleted successfully
                requireContext(),
                "Successfully removed ${args.currentUser.first_name}",
                Toast.LENGTH_SHORT
            )
                .show()
        ...
        builder.setTitle("Delete ${args.currentUser.first_name} ?")  // Set the title of the prompt with a sentence saying the first name of the user inside the app (using template string)
        builder.setMessage("Are you sure to remove ${args.currentUser.first_name} ?")  // Set the message of the prompt with a sentence saying the first name of the user inside the app (using template string)
        builder.create()
